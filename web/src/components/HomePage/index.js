    ...
    return(
        ...
        <body class="is-preload">
			...
			<nav id="menu">
				<ul class="links">
					<li><a href="/">Home</a></li>
					<li><a href="cadastro">Elements</a></li>
					<li><a href="login">Generic</a></li>
				</ul>
			</nav>
			...
			<script src="../../assets_template/js/browser.min.js"></script>
			<script src="../../assets_template/js/breakpoints.min.js"></script>
